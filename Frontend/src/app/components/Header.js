  ...
  ${isVisible ? "top-0 bg-white" : "-top-28 bg-transparent"}`} >
      ...
      <nav className="border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
          ...
          <div className={` ${open ? 'opacity-100 max-h-[500px] ' : 'hidden'} transition-all duration-500 ease-in-out justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-1`}>
