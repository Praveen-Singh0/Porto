...
export default function ChatPage() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    ...
    },
    {
      ...
      userId: "1",
      content:
        "Hello John! I'd be happy to help you with your booking. What specific issue are you facing?",
    ...
    },
    {
      ...
      userId: "1",
      content:
        "Let me check that for you. Can you provide me with your booking reference number?",
                ...
                <motion.div
                  ...
                  className={`p-4 border-b border-gray-100 dark:border-gray-800 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors ${
                    selectedUser === chat.userId
                      ? "bg-red-50 dark:bg-red-900/20 border-r-2 border-r-red-500"
                      : ""
                  }`}
