...
const LoginModal: React.FC<LoginModalProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      showToast({ message: error.message || "Failed to login", type: "error" });
    } finally {
      setLoading(false);
    }
  };
    ...
    >
      <div
        ...
        className={`max-w-[450px] w-full mx-4 ${neumorphicBase} 
          rounded-3xl shadow-[0px_0px_30px_#bebebe] dark:shadow-[0px_0px_30px_#0a0a0a]
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  ${neumorphicBase} ${neumorphicShadow} transition-all duration-200 
